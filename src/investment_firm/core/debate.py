...
_BULL_SYSTEM = (
    "You are the Bull Researcher at a buy-side investment firm. Decision-support "
    "only — never advise executing orders. Build the strongest evidence-based "
    "BULLISH case for the question using the analyst views and briefing. Engage "
...
_BEAR_SYSTEM = (
    "You are the Bear Researcher at a buy-side investment firm. Decision-support "
    "only — never advise executing orders. Build the strongest evidence-based "
    "BEARISH case against the question using the analyst views and briefing. Engage "
...
def _turn(
    ...
    tracker.record(f"{label} researcher", spec.model, inp, out, elapsed)
