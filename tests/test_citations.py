...
def _spec(name: str = "equity_analyst", model: str = "claude-4.5-haiku") -> RoleSpec:
    return RoleSpec(name=name, group="research", tier="WORKER", model=model,
                    mandate="Test mandate.")


_CLEAN_VIEW = json.dumps({
    "stance": "BULLISH", "conviction": 4, "rationale": "ok",
    "key_risks": ["recession"], "evidence": ["tool: +5%"],
})
...
class TestExtractCitations:
    def test_gemini_openai_annotations(self):
        ...
        assert cites == [{"url": "https://example.com/a", "title": "example.com",
                          "origin": "web:gemini"}]
                ...
                {"type": "web_search_tool_result",
                 "content": [
                     {"type": "web_search_result",
                      "url": "https://news.example/x", "title": "News X"},
                 ]},
    ...
    def test_dedup_by_url(self):
        resp = {
            "content": [
                {"type": "text", "text": "a",
                 "citations": [{"url": "https://same.example", "title": "1"},
...
class TestCleanStrList:
    ...
    def test_salvage_key_risks_bounded_to_bracket(self):
        ...
        text = ('{"stance": "BEARISH", "rationale": "r", '
...
class TestStaleness:
    ...
    def test_stale_note_recorded_in_memory(self, fake_llm):
        ...
        registry = ToolRegistry([
            Tool("get_prices", "d", {"type": "object", "properties": {}},
